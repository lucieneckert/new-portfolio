...
// Adapted from course materials from INFO 2300, 
// Credit: Prof. Kyle Harms
...
function create_account($db, $username, $password)
{
  ...
  if ($account_valid) {
    $result = exec_query_params(
      $db,
      "INSERT INTO users (username, password, stars) VALUES (:username, :password, 0);",
      array(
        ':username' => $username,
