...
<p>
    ...
    focus around the game's audio features. As part of the course's requirements, the game targeted mobile devices, which brought with it myriad challenges --
    especially when it came to audio and playtesting.
</p>

<p>
    Our game was a sort of turn-based drawing/fighting game, supporting up to four player networked multiplayer where each battles to be the last one standing. The gist of the gameplay is that on a player's turn, they can expend ink to draw paths within a limited radius that, upon the end of the turn, drag and fling objects as directed.
