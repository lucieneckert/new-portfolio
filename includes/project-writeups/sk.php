...
<ul><li>Stat boost power ups can be collected, increasing each specific stat of any vehicle that player rides</li>
...
<img src="public/project-info-res/sk/dbug.png" alt="screenshot of early grand dark bug vehicle">
    <figcaption>
        ...
        close in and intercept opponents that get careless. This vehicle can cast a debuff on vehicles within a range,
...
<div class='project-info-gallery'>
    <figure>
        ...
        <figcaption>Footage of our early drifting in the Torus vehicle. Vehicles start with low base stats, so the speed
            and drift boost in this clip are both low. 
        </figcaption>
    </figure>
